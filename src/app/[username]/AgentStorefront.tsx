...
export default function AgentStorefront({
  ...
  const aboutBody = () => (<>
    ...
    <div className="ab-founder ab-founder-m">
      <div className="ab-portrait">{store.founder_avatar_url ? <img src={store.founder_avatar_url} alt={DUMMY_AUTHOR.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <span className="ab-portrait-mono">{DUMMY_AUTHOR.initial}</span>}<span className="ab-portrait-tag">Agent</span></div>
...
.ps-root{--brand:#1f4e87;--brand-deep:#12305a;--gold:#c79a4b;--bg:#faf4ef;--card:#fff;--ink:#1b2533;
  ...
  --shadow-sm:0 1px 2px rgba(27,37,51,.04),0 2px 8px rgba(27,37,51,.05);
  --shadow-md:0 4px 12px rgba(27,37,51,.06),0 10px 28px rgba(27,37,51,.08);
  --shadow-lg:0 8px 24px rgba(27,37,51,.09),0 20px 48px rgba(27,37,51,.11);
...
.ps-book-btn:hover,.ps-sheet-cta:hover{box-shadow:0 8px 22px rgba(31,78,135,.4);transform:translateY(-1px);}
.ps-book-btn:active,.ps-sheet-cta:active{transform:translateY(2px);box-shadow:0 3px 10px rgba(31,78,135,.26);}
...
.ps-mini:hover{box-shadow:0 5px 14px rgba(31,78,135,.36);transform:translateY(-1px);}
.ps-mini:active{transform:translateY(1px);box-shadow:0 2px 6px rgba(31,78,135,.24);}
...
.ps-seeall:hover{background:#e8eef6;border-color:var(--brand);}
...
.ps-dir:hover{background:#e8eef6;border-color:var(--brand);}
...
.pd-railbtns button:hover{background:#e8eef6;border-color:var(--brand);}

          ...
          <div className="lst-detail">
            ...
            <div className="lst-act">
              ...
              <div className="lst-act-btns">
                <button className="lst-msg" onClick={() => ping("Opening WhatsApp")}><WhatsApp size={15} /> Enquire</button>
                {taken
                    ...
                    <div className="svc-body">
                      <aside className="svc-rail">
                        ...
                        <div className="svc-book-card">
                          ...
                          <button className="svc-msg" onClick={() => ping("Opening WhatsApp")}><WhatsApp size={15} /> Ask about a guide</button>
                        </div>
                      </aside>

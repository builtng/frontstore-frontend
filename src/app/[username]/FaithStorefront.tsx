...
interface FaithStorefrontProps {
  username: string;
  store: StoreType;
  categories: Category[];
  products: Product[];
...
const MOCK_SERVICE_INFO = {
  s1: { includes: ["Seat reservation for your preferred service time", "Family group registration in one form", "Confirmation sent via WhatsApp", "Childcare available on request, mention at registration", "Arrive 15 minutes before service time", "Seats are held until 5 minutes before the service begins"] },
  s2: { includes: ["Seat registration for Thursday 6pm service", "Childcare available for ages 3 to 10", "Confirmation sent on WhatsApp", "Worship, Word and prayer, approximately 2 hours", "Open to first-time visitors and regular members", "No dress code requirement beyond modest attire"] },
  s3: { includes: ["Baptismal preparation class the Sunday before", "Bring a change of clothes and a towel", "Full immersion baptism ceremony", "Group photos shared with participants", "A personal baptism certificate issued", "Family and friends welcome to attend and witness"] },
  s4: { includes: ["Four Sunday sessions with a senior pastor", "Topics: our beliefs, our community, membership process", "Course material provided in the first session", "Open Q&A at the end of each session", "Certificate of membership issued on completion", "No prior church experience required"] },
  s5: { includes: ["Three days of morning and evening sessions", "All course materials and conference pack included", "Daily lunch for all registered delegates", "Access to all main sessions and workshops", "Early bird pricing available", "Confirmation and schedule sent on WhatsApp"] },
  s6: { includes: ["Full weekend accommodation at the retreat centre", "All meals and snacks provided", "Morning devotion, sessions and evening activities", "A personal journal and camp materials included", "Transportation from church on request", "Supervised by youth pastoral team throughout"] },
  s7: { includes: ["Consultation with our lead pastor or marriage counsellor", "Overview of our pre-marital counselling programme", "Available ceremony dates and how to book the church", "Requirements for wedding rehearsal and set-up", "Guidance on church protocol for the wedding day", "Follow-up session to agree timeline and details"] },
  s8: { includes: ["Secure payment by card or bank transfer", "Designate your giving: tithe, offering or special project", "Automatic receipt issued to your email and WhatsApp", "Set up a recurring giving commitment", "All giving is acknowledged and receipted", "100% of funds go to the designated purpose"] },
};
...
const MOCK_NOTIFY_TOPICS = [["services", "Service schedules"], ["events", "Upcoming events"], ["giving", "Giving opportunities"], ["news", "Church announcements"]];
const MOCK_HOURS = [
  ["Mon", "Closed"], ["Tue", "Closed"], ["Wed", "9:00am - 5:00pm"],
  ["Thu", "5:00pm - 8:00pm"], ["Fri", "9:00am - 5:00pm"], ["Sat", "9:00am - 2:00pm"], ["Sun", "7:00am - 1:00pm"],
];
const MOCK_NAV = [
  ["home", "Home"], ["services", "Services"], ["products", "Shop"], ["portfolio", "Gallery"], ["reviews", "Testimonials"], ["blog", "Blog"],
...
export default function FaithStorefront({
  username,
  store,
  categories,
  products,
  ...
  const customBrandColor = store.primary_color || '#d97706';
  const customBrandDeep = store.primary_color ? `color-mix(in srgb, ${store.primary_color} 80%, black)` : '#b45309';
  const customTint = store.primary_color ? `color-mix(in srgb, ${store.primary_color} 14%, white)` : '#fffbeb';
  ...
  const primaryCta = ({
    ...
    book: { label: "Register now", Icon: Calendar, run: () => openBooking() },
  ...
  } as Record<string, any>)[DUMMY_STORE.primaryCta as any] || { label: "Register now", Icon: Calendar, run: () => openBooking() };
...
`;
  ...
  const serviceView = () => {
    ...
    const steps = [
      ["Register or give online", "Select the service or giving type, complete the form and confirm. Registration is immediate and free for most services."],
      ["Receive your WhatsApp confirmation", "A confirmation is sent to your WhatsApp with all the details: date, time, location and what to bring."],
      ["Arrive ready", "Turn up at the specified time. Our ushers are at every entrance for services and events."],
      ["Belong and grow", "Every service, event and programme is designed to help you go deeper in faith and community."],
    ];
    const brings = ["Immediate WhatsApp confirmation", "Clear directions and what to expect on arrival", "A welcoming community when you get here"];
    return (
        ...
        <div className="sv-grid">
          ...
          <aside className="sv-side">
            <div className="sv-card">
              ...
              <p className="sv-note">A deposit of about {money(deposit)} secures your slot. The balance is paid after the session, once you are happy.</p>
      ...
      <div className="ct-visit">
        ...
        <div className="ct-hours">
          ...
          {hasHours ? (
            ...
            <p className="ct-hours-empty">This church hasn't added service or opening hours yet. Message on WhatsApp to check availability.</p>
          )}
        </div>
      ...
      <div className="rf-section">
        ...
        <ul className="rf-list">
          {store.policy_bookings ? (
            ...
            <>
              <li><Check size={15} /> Reschedule or cancel up to 24 hours before your session for a full refund of your deposit.</li>
              ...
              <div className="pd-listing">
                ...
                {page === "services" && (
                  <div className="svc-page">
                    <p className="svc-intro">Register now with our team. A deposit secures your slot, with the balance paid after the session.</p>
                    ...
                    <div className="blogp-body">
                      ...
                      <aside className="blogp-rail">
                        <div className="author-card">
                          ...
                          <p>{DUMMY_AUTHOR.bio}</p>
                          <div className="author-cred"><Sparkles size={13} /> Over 8 years serving the community across Lagos</div>
                          <button className="author-link" onClick={() => go("about")}>More about {DUMMY_AUTHOR.name.split(" ")[0]} <ChevronRight size={14} /></button>
                        </div>
                        <div className="blog-convert">
                          <b>Enjoyed the read?</b>
              ...
              <div className="pd-listing">
                ...
                <div className="ab-wrap">
                  <div className="ab-main">
                    ...
                    <h2 className="ab-headline">A community you can find, and a place that welcomes you home.</h2>
                    ...
                    <div className="ab-approach">
                      ...
                      <div className="ab-approach-grid">
                        <div><span className="ab-num">01</span><b>We learn your need</b><p>Every registration starts by understanding what you're looking for, so the session suits you and where you are.</p></div>
                        <div><span className="ab-num">02</span><b>The right approach</b><p>We bring the right people and format for you, not a one size fits all routine.</p></div>
                        <div><span className="ab-num">03</span><b>Made to last</b><p>From a quick chat to a full programme, it's done properly, not just quickly.</p></div>
                      </div>
                    </div>
                  ...
                  <aside className="ab-rail">
                    ...
                    <div className="blog-convert">
                      ...
                      <p>Browse the full list of services.</p>
                      <button className="blog-convert-cta" onClick={() => openBooking()}><Calendar size={15} /> Register now</button>
                      {(store.storefront_sections || []).includes("services") && (
          <button className="blog-convert-ghost" onClick={() => go("services")}>Browse services</button>
        )}
...
const css = `
.ps-root{--brand:#d97706;--brand-deep:#b45309;--gold:#c79a4b;--bg:#f4f8f8;--card:#fff;--ink:#18272a;
...
.ps-url{display:inline-flex;align-items:center;gap:7px;font-size:12.5px;font-weight:600;color:var(--brand-deep);background:#fef3c7;padding:7px 12px;border-radius:9px;margin-top:11px;max-width:100%;min-width:0}
...
.nt-topic.on{background:#fef3c7;border-color:var(--brand);color:var(--brand-deep);}
...
.ps-sig-tag{display:inline-flex;align-items:center;gap:5px;font-size:10.5px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:var(--brand-deep);background:#fef3c7;padding:4px 9px;border-radius:7px;}
...
.ps-book-btn:hover,.ps-sheet-cta:hover{box-shadow:0 8px 22px rgba(15,157,142,.4);transform:translateY(-1px);}
.ps-book-btn:active,.ps-sheet-cta:active{transform:translateY(2px);box-shadow:0 3px 10px rgba(15,157,142,.26);}
...
.ps-mini:hover{box-shadow:0 5px 14px rgba(15,157,142,.36);transform:translateY(-1px);}
.ps-mini:active{transform:translateY(1px);box-shadow:0 2px 6px rgba(15,157,142,.24);}
...
.ps-seeall:hover{background:#fef3c7;border-color:var(--brand);}
...
.ps-dir:hover{background:#fef3c7;border-color:var(--brand);}
...
.ps-locked{background:#fef3c7;border:1px solid #c8e6e2;border-radius:14px;padding:14px;margin:16px 0 8px;}
...
.ps-nav button.on{background:#fef3c7;color:var(--brand-deep);font-weight:700;}
...
.bk-svcbar{display:flex;align-items:center;justify-content:space-between;gap:10px;background:#fef3c7;border:1px solid #c8e6e2;border-radius:12px;padding:10px 13px;margin-bottom:16px;}
...
.bk-deposit-row{display:flex;align-items:center;justify-content:space-between;margin-top:16px;padding:12px 14px;background:#fef3c7;border:1px solid #c8e6e2;border-radius:12px;}
...
.pd-tabs button.on{background:#fef3c7;color:var(--brand-deep);font-weight:700;}
...
.pd-railbtns button:hover{background:#fef3c7;border-color:var(--brand);}
.pd-railcard.trust{background:#fef3c7;border-color:#c8e6e2;}
...
.feat-tag{display:inline-flex;align-items:center;gap:6px;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:var(--brand-deep);background:#fef3c7;padding:5px 11px;border-radius:8px;}
...
.blog-convert{background:#fef3c7;border:1px solid #c8e6e2;border-radius:16px;padding:17px;}
...
.ab-chips span{font-size:11.5px;font-weight:600;color:var(--brand-deep);background:#fef3c7;border:1px solid #ecd2dd;padding:5px 11px;border-radius:16px;}
...
.ab-follow-icons button{width:40px;height:40px;border-radius:11px;display:grid;place-items:center;background:#fef3c7;border:1px solid #ecd2dd;color:var(--brand-deep);transition:background .12s,color .12s;}
...
.ab-verified{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:700;color:var(--brand-deep);background:#fef3c7;border:1px solid #ecd2dd;padding:4px 10px;border-radius:16px;margin-top:8px;}
...
.ab-review{position:relative;background:#fef3c7;border:1px solid #c8e6e2;border-radius:18px;padding:24px;margin:28px 0;}
...
.faq-cats button:hover{background:#fef3c7;color:var(--brand-deep);}
.faq-cats button svg{color:var(--brand);flex:0 0 auto;}
.faq-help{background:#fef3c7;border:1px solid #c8e6e2;border-radius:16px;padding:17px;}
...
.ct-hours-list li.today{background:#fef3c7;color:var(--brand-deep);}
...
.rf-related button:hover{background:#fef3c7;color:var(--brand-deep);}
...
.tm-contents button:hover{background:#fef3c7;color:var(--brand-deep);}
...
.svc-radios button.on{background:#fef3c7;color:var(--brand-deep);font-weight:700;}
...
.rev-card-svc{display:inline-block;font-size:11px;font-weight:700;color:var(--brand-deep);background:#fef3c7;padding:3px 9px;border-radius:7px;margin:11px 0 8px;}
...
.rev-form-note{display:flex;align-items:flex-start;gap:7px;font-size:12.5px;color:#54636a;line-height:1.5;background:#fef3c7;border:1px solid #c8e6e2;border-radius:11px;padding:11px 12px;margin-bottom:6px;}

...
`;
  ...
  const aboutBody = () => (<>
    ...
    <p className="ab-para">What began in 2019 with one pickup route is now a laundry service that Lagos genuinely trusts with its best clothes, known for fresh results and delivery that arrives on time.</p>

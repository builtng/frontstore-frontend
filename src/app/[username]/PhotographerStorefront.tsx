            ...
            {page === "home" && (<>
              ...
              <div className="pd-home">
                ...
                <div className="pd-feed">
                  {featured}
                  <div className="pd-sec-head"><h2>Sessions</h2><button onClick={() => go("services")}>See all {SERVICES.length}</button></div>
                  {servicesGrid("pd-grid", homeServices.slice(0, 6))}
                  <div className="pd-sec-head"><h2>Prints</h2><button onClick={() => go("products")}>See all {PRODUCTS.length}</button></div>

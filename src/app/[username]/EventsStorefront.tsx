...
export default function EventsStorefront({
  ...
  const aboutBody = () => (<>
    ...
    <p className="ab-para">What began in 2014 styling friends' weddings is now a full design studio with a small, trusted team, known for warm, considered events that still feel effortless.</p>

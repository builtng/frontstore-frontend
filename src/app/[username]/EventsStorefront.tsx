...
interface EventsStorefrontProps {
  username: string;
  store: StoreType;
  categories: Category[];
  products: Product[];
...
const MOCK_NAV = [
  ["home", "Home"], ["services", "Packages"], ["products", "Guides"], ["portfolio", "Gallery"], ["reviews", "Reviews"], ["blog", "Blog"],
...
export default function EventsStorefront({
  username,
  store,
  categories,
  products,
  ...
  const customBrandColor = store.primary_color || '#1f7a5a';
  const customBrandDeep = store.primary_color ? `color-mix(in srgb, ${store.primary_color} 80%, black)` : '#10402f';
  ...
  const primaryCta = ({
    ...
    book: { label: "Book us", Icon: Calendar, run: () => openBooking() },
  ...
  } as Record<string, any>)[DUMMY_STORE.primaryCta as any] || { label: "Book us", Icon: Calendar, run: () => openBooking() };
  ...
  const bookingFlow = () => {
    ...
    return (
      <Sheet onClose={() => setBookOpen(false)} onBack={onBack} title={(titles as any)[bookStep]}>
        {bookStep === "service" && (<>
          <p className="ps-sheet-sub">Pick the package or service you would like to book.</p>
        ...
        {bookStep === "review" && (<>
          ...
          <textarea className="bk-input bk-textarea" value={bookNote} onChange={(e) => setBookNote(e.target.value)} placeholder="Theme, colours, venue, guest count, anything useful" />
          <div className="bk-deposit-row"><span><Lock size={13} /> Deposit to secure</span><b>{money(deposit)}</b></div>
          <p className="ps-deposit">Frontstore holds your deposit until your event, then the {money(bookSvc.price - deposit)} balance is due before the day. Covered by buyer protection.</p>
  ...
  const aboutBody = () => (<>
      ...
      <div className="ab-offer-grid ab-grid-m">
        {MOCK_OFFERINGS.map(([t, d, pg]: any) => (
          <button key={t} className="ab-offer-card" onClick={() => go(pg)}>
            <b>{t}</b>
            <p>{d}</p>
            <span className="ab-offer-link">{pg === "products" ? "View guides" : "View packages"} <ChevronRight size={14} /></span>
          </button>
        ))}
      </div>
    </div>
    ...
    <button className="ab-book-m" onClick={() => openBooking()}><Calendar size={16} /> Book a package</button></>);
  const faqSections = () => (
      ...
      <div className="rf-section">
        ...
        <ul className="rf-list">
          {store.policy_bookings ? (
            ...
            <>
              <li><Check size={15} /> Move your date or cancel up to 30 days before your event for a full refund of your deposit.</li>
              <li><Check size={15} /> Within 30 days of your event, the deposit is held against the booking and is not refunded.</li>
        ...
        <ul className="rf-list">
          {store.policy_products ? (
            ...
            <>
              ...
              <li><Check size={15} /> Digital guides cannot be refunded once downloaded, and custom favours cannot be returned unless they are faulty.</li>
  ...
  const portfolioBody = () => (<>
    <p className="svc-intro">A look at recent work from the store, from weddings to corporate events and celebrations.</p>
    {portfolioChips()}
    {portfolioGrid()}
    <button className="ab-book-m" onClick={() => openBooking()}><Calendar size={16} /> Book a package</button>
    {portfolioFollow()}
        ...
        <div className="art-wrap">
          ...
          <aside className="art-rail">
            ...
            <div className="blog-convert">
              ...
              <p>Book us for your event, or grab a planning guide to do it yourself.</p>
              <button className="blog-convert-cta" onClick={() => openBooking()}><Calendar size={15} /> Book a package</button>
            ...
            {page === "home" && (<>
              <section className="ps-cover-wrap">
                ...
                <div className="ps-stats">
                  ...
                  {DUMMY_STORE.orders ? <div><b>{DUMMY_STORE.orders}</b><span>events styled</span></div> : null}
              ...
              <div className="pd-listing">
                ...
                {page === "services" && (
                  <div className="svc-page">
                    <p className="svc-intro">Book us for your event. A deposit secures your date, with the balance paid before the day.</p>
                    ...
                    <div className="svc-body">
                      <aside className="svc-rail">
                        <div className="svc-search">
                          <Search size={16} />
                          <input value={svcQuery} onChange={(e) => setSvcQuery(e.target.value)} placeholder="Search packages" />
                  ...
                  <div className="svc-page">
                    ...
                    <div className="svc-body">
                      <aside className="svc-rail">
                        <div className="svc-search">
                          <Search size={16} />
                          <input value={prodQuery} onChange={(e) => setProdQuery(e.target.value)} placeholder="Search guides" />
                    ...
                    <div className="blogp-body">
                      ...
                      <aside className="blogp-rail">
                        <div className="author-card">
                          ...
                          <p>{DUMMY_AUTHOR.bio}</p>
                          <div className="author-cred"><Sparkles size={13} /> Over 10 years in bridal, skin and hair</div>
                          <button className="author-link" onClick={() => go("about")}>More about {DUMMY_AUTHOR.name.split(" ")[0]} <ChevronRight size={14} /></button>
                        </div>
                        <div className="blog-convert">
                          <b>Enjoyed the read?</b>
          ...
          <button className="blog-convert-ghost" onClick={() => go("products")}>View guides</button>
            ...
            {page === "portfolio" && (
              <div className="pd-listing">
                ...
                <p className="svc-intro">A look at recent work from the store, from weddings to corporate events and celebrations. Tap any image to see it larger.</p>
                {portfolioChips()}
                <div className="pf-wrap">
                  ...
                  <aside className="pf-rail">
                    <div className="blog-convert">
                      ...
                      <p>Book us to style your event.</p>
                      <button className="blog-convert-cta" onClick={() => openBooking()}><Calendar size={15} /> Book a package</button>
                      {(store.storefront_sections || []).includes("services") && (
                ...
                <div className="ab-wrap">
                  <div className="ab-main">
                    ...
                    <div className="ab-approach">
                      ...
                      <div className="ab-approach-grid">
                        <div><span className="ab-num">01</span><b>Consultation first</b><p>Every booking opens with a short consult so the look suits your venue, your guests and your day.</p></div>
                        ...
                        <div><span className="ab-num">03</span><b>Made to last</b><p>From intimate dinners to full weddings, the work is built to look right from setup to the very last photo.</p></div>
                      </div>
                    </div>
                  ...
                  <aside className="ab-rail">
                    ...
                    <div className="blog-convert">
                      ...
                      <p>Book a package, or browse the full list of services.</p>
                      <button className="blog-convert-cta" onClick={() => openBooking()}><Calendar size={15} /> Book a package</button>
                      {(store.storefront_sections || []).includes("services") && (
          <button className="blog-convert-ghost" onClick={() => go("services")}>Browse services</button>
        )}
              ...
              <div className="pd-listing">
                ...
                <div className="ct-wrap">
                  ...
                  <aside className="ct-rail">
                    ...
                    <div className="blog-convert">
                      <b>Prefer to book?</b>
                      <p>Skip the message and book us in a couple of taps.</p>
                      <button className="blog-convert-cta" onClick={() => openBooking()}><Calendar size={15} /> Book a package</button>
                      {(store.storefront_sections || []).includes("services") && (
          <button className="blog-convert-ghost" onClick={() => go("services")}>Browse services</button>
        )}
...
const css = `
.ps-root{--brand:#1f7a5a;--brand-deep:#10402f;--gold:#c79a4b;--bg:#faf4ef;--card:#fff;--ink:#1b2a23;
  --muted:#778a81;--line:#e7e0d4;--ok:#1f9d57;--wa:#25d366;
  --shadow-sm:0 1px 2px rgba(27,42,35,.04),0 2px 8px rgba(27,42,35,.05);
  --shadow-md:0 4px 12px rgba(27,42,35,.06),0 10px 28px rgba(27,42,35,.08);
  --shadow-lg:0 8px 24px rgba(27,42,35,.09),0 20px 48px rgba(27,42,35,.11);
...
.ps-url{display:inline-flex;align-items:center;gap:7px;font-size:12.5px;font-weight:600;color:var(--brand-deep);background:#e6f1ec;padding:7px 12px;border-radius:9px;margin-top:11px;max-width:100%;min-width:0}
...
.ps-notify{display:inline-flex;align-items:center;gap:6px;font-size:12.5px;font-weight:700;color:#fff;background:var(--brand);padding:8px 13px;border-radius:9px;box-shadow:0 4px 12px rgba(31,122,90,.28);cursor:pointer;flex-shrink:0}
.nt-topics{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:4px;}
.nt-topic{display:inline-flex;align-items:center;gap:6px;font-size:12.5px;font-weight:600;padding:9px 13px;border-radius:11px;border:1px solid var(--line);background:var(--card);color:#36473f;cursor:pointer;}
.nt-topic.on{background:#e6f1ec;border-color:var(--brand);color:var(--brand-deep);}
...
.ps-bio{font-size:14px;line-height:1.55;color:#36473f;margin-top:15px;}
...
.ps-signature{background:var(--card);border:1px solid var(--line);border-radius:16px;padding:14px;margin-bottom:18px;box-shadow:0 8px 22px rgba(16,64,47,.07);}
.ps-sig-tag{display:inline-flex;align-items:center;gap:5px;font-size:10.5px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:var(--brand-deep);background:#e6f1ec;padding:4px 9px;border-radius:7px;}
...
.ps-book-btn,.ps-sheet-cta{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:15px;padding:13px;border-radius:12px;box-shadow:0 6px 16px rgba(31,122,90,.3);}
.ps-book-btn:hover,.ps-sheet-cta:hover{box-shadow:0 8px 22px rgba(31,122,90,.4);transform:translateY(-1px);}
.ps-book-btn:active,.ps-sheet-cta:active{transform:translateY(2px);box-shadow:0 3px 10px rgba(31,122,90,.26);}
...
.ps-chips button{flex:0 0 auto;font-size:13px;font-weight:600;padding:8px 14px;border-radius:20px;background:var(--card);border:1px solid var(--line);color:#36473f;}
...
.ps-mini{font-size:13px;font-weight:700;padding:7px 15px;border-radius:9px;color:#fff;background:var(--brand);box-shadow:0 3px 8px rgba(31,122,90,.28);}
.ps-mini:hover{box-shadow:0 5px 14px rgba(31,122,90,.36);transform:translateY(-1px);}
.ps-mini:active{transform:translateY(1px);box-shadow:0 2px 6px rgba(31,122,90,.24);}
...
.ps-seeall:hover{background:#e6f1ec;border-color:var(--brand);}
...
.ps-review p{font-size:13px;line-height:1.5;color:#36473f;}
...
.ps-addr{display:flex;align-items:flex-start;gap:7px;font-size:13.5px;color:#36473f;line-height:1.5;}
...
.ps-dir:hover{background:#e6f1ec;border-color:var(--brand);}
.ps-hours{list-style:none;margin-top:14px;border-top:1px solid var(--line);}
.ps-hours li{display:flex;justify-content:space-between;font-size:13px;padding:7px 0;border-bottom:1px solid var(--line);color:#46564e;}
...
.ps-acc-item p{padding:0 14px 14px;font-size:13px;line-height:1.55;color:#36473f;}

.ps-locked{background:#e6f1ec;border:1px solid #cfe3d9;border-radius:14px;padding:14px;margin:16px 0 8px;}
...
.ps-locked p{font-size:12.5px;line-height:1.55;color:#54655c;margin-top:8px;}
...
.ps-prose{font-size:14px;line-height:1.65;color:#36473f;margin-bottom:13px;}
...
.ps-foot-links button{font-size:12px;font-weight:600;color:#54655c;}
...
.ps-nav button{display:flex;align-items:center;justify-content:space-between;text-align:left;font-size:14.5px;font-weight:500;padding:11px 12px;border-radius:10px;color:#36473f;}
.ps-nav button.on{background:#e6f1ec;color:var(--brand-deep);font-weight:700;}
.ps-panel-actions{display:flex;flex-direction:column;gap:9px;margin-top:auto;}
.ps-act-book{display:flex;align-items:center;justify-content:center;gap:8px;background:var(--brand);color:#fff;font-weight:700;font-size:14.5px;padding:13px;border-radius:12px;box-shadow:0 6px 16px rgba(31,122,90,.3);}
...
.ps-fab svg{position:relative;z-index:1;width:54px;height:54px;background:var(--brand);color:#fff;padding:16px;border-radius:50%;box-shadow:0 8px 20px rgba(31,122,90,.4);margin-top:-26px;}
...
.ps-field-lbl{font-size:12.5px;font-weight:700;color:#46564e;margin:14px 0 8px;}
.ps-pick{display:flex;gap:9px;flex-wrap:wrap;}
.ps-pick button{font-size:13px;font-weight:600;padding:9px 15px;border-radius:11px;border:1px solid var(--line);background:var(--card);color:#36473f;}
...
.bk-svcbar{display:flex;align-items:center;justify-content:space-between;gap:10px;background:#e6f1ec;border:1px solid #cfe3d9;border-radius:12px;padding:10px 13px;margin-bottom:16px;}
...
.bk-deposit-row{display:flex;align-items:center;justify-content:space-between;margin-top:16px;padding:12px 14px;background:#e6f1ec;border:1px solid #cfe3d9;border-radius:12px;}
...
.ps-search-lbl{font-size:12px;font-weight:700;color:#46564e;margin-bottom:9px;}
...
.ps-toast{position:fixed;left:50%;bottom:96px;transform:translateX(-50%);background:#1b2a23;color:#fff;font-size:13px;font-weight:600;padding:11px 18px;border-radius:11px;box-shadow:0 8px 24px rgba(0,0,0,.25);z-index:90;animation:pstoast .2s;}
...
.pd-head-book{display:flex;align-items:center;gap:7px;background:var(--brand);color:#fff;font-weight:700;font-size:14px;padding:11px 18px;border-radius:12px;box-shadow:0 5px 14px rgba(31,122,90,.3);}
...
.pd-avatar{width:128px;height:128px;border-radius:30px;flex:0 0 auto;background:linear-gradient(150deg,var(--brand),var(--brand-deep));color:#fff;font-family:'Fraunces';font-weight:700;font-size:56px;display:grid;place-items:center;border:6px solid var(--bg);box-shadow:0 10px 28px rgba(16,64,47,.22);}
...
.pd-book{display:flex;align-items:center;gap:7px;background:var(--brand);color:#fff;font-weight:700;font-size:14.5px;padding:12px 22px;border-radius:12px;box-shadow:0 6px 16px rgba(31,122,90,.3);}
...
.pd-tabs button{font-size:14px;font-weight:600;padding:10px 16px;border-radius:10px;color:#46564e;white-space:nowrap;}
.pd-tabs button:hover{background:#f3e7e1;}
.pd-tabs button.on{background:#e6f1ec;color:var(--brand-deep);font-weight:700;}
...
.pd-railcard>p{font-size:13px;line-height:1.55;color:#36473f;}
...
.pd-railbtns button:hover{background:#e6f1ec;border-color:var(--brand);}
.pd-railcard.trust{background:#e6f1ec;border-color:#cfe3d9;}
.pd-trust-h{display:flex;align-items:center;gap:7px;font-size:13.5px;font-weight:700;color:var(--brand-deep);}
.pd-railcard.trust p{font-size:12px;line-height:1.55;color:#54655c;margin-top:8px;}
...
.pd-filter button{font-size:13px;font-weight:600;padding:8px 16px;border-radius:20px;background:var(--card);border:1px solid var(--line);color:#36473f;}
...
.feat-tag{display:inline-flex;align-items:center;gap:6px;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:var(--brand-deep);background:#e6f1ec;padding:5px 11px;border-radius:8px;}
...
.feat-card{flex:0 0 76%;max-width:280px;background:var(--card);border:1px solid var(--line);border-radius:16px;overflow:hidden;box-shadow:0 8px 22px rgba(16,64,47,.08);display:flex;flex-direction:column;}
...
.feat-cta{font-size:13px;font-weight:700;padding:8px 18px;border-radius:10px;color:#fff;background:var(--brand);box-shadow:0 4px 10px rgba(31,122,90,.3);}
...
.blog-card:hover{transform:translateY(-2px);box-shadow:0 12px 28px rgba(16,64,47,.1);}
...
.blog-body p{font-size:13px;color:#54655c;line-height:1.5;}
...
.blog-topics button{font-size:13px;font-weight:600;padding:8px 16px;border-radius:20px;background:var(--card);border:1px solid var(--line);color:#36473f;}
...
.blog-hero:hover{transform:translateY(-2px);box-shadow:0 14px 32px rgba(16,64,47,.1);}
...
.blog-hero-body>p{font-size:14px;color:#46564e;line-height:1.55;}
...
.author-card>p{font-size:12.5px;line-height:1.55;color:#46564e;}
...
.blog-convert{background:#e6f1ec;border:1px solid #cfe3d9;border-radius:16px;padding:17px;}
.blog-convert>b{font-family:'Fraunces';font-weight:600;font-size:16px;}
.blog-convert>p{font-size:12.5px;color:#54655c;line-height:1.5;margin:6px 0 13px;}
.blog-convert-cta{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:13.5px;padding:11px;border-radius:11px;box-shadow:0 6px 14px rgba(31,122,90,.28);}
...
.ab-lede{font-size:15.5px;line-height:1.6;color:#46564e;max-width:none;}
...
.ab-bio{font-size:14px;line-height:1.6;color:#46564e;margin:13px 0;}
.ab-chips{display:flex;flex-wrap:wrap;gap:7px;margin-bottom:14px;}
.ab-chips span{font-size:11.5px;font-weight:600;color:var(--brand-deep);background:#e6f1ec;border:1px solid #ecd2dd;padding:5px 11px;border-radius:16px;}
...
.ab-approach-grid p{font-size:13px;line-height:1.55;color:#46564e;}
...
.ab-addr{font-size:13px;line-height:1.5;color:#36473f;margin:12px 0 8px;}
...
.ab-follow-icons button{width:40px;height:40px;border-radius:11px;display:grid;place-items:center;background:#e6f1ec;border:1px solid #ecd2dd;color:var(--brand-deep);transition:background .12s,color .12s;}
...
.ab-book-m{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;margin-top:18px;background:var(--brand);color:#fff;font-weight:700;font-size:15px;padding:14px;border-radius:13px;box-shadow:0 8px 18px rgba(31,122,90,.3);}
.ab-para{font-size:14.5px;line-height:1.65;color:#46564e;max-width:none;margin-top:13px;}
...
.ab-offer-card:hover{transform:translateY(-2px);box-shadow:0 12px 26px rgba(16,64,47,.09);border-color:#cfe3d9;}
.ab-offer-card b{display:block;font-size:15.5px;font-weight:700;margin-bottom:6px;}
.ab-offer-card p{font-size:13px;line-height:1.55;color:#46564e;margin-bottom:11px;}
...
.ab-fact-v{font-size:13.5px;color:#36473f;line-height:1.45;}
.ab-grid-m{grid-template-columns:1fr;}
.ab-facts-m{grid-template-columns:1fr;}
.ab-verified{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:700;color:var(--brand-deep);background:#e6f1ec;border:1px solid #ecd2dd;padding:4px 10px;border-radius:16px;margin-top:8px;}
...
.ab-creds li{display:flex;align-items:flex-start;gap:8px;font-size:13px;line-height:1.45;color:#36473f;}
...
.ab-shot:hover{transform:translateY(-2px);box-shadow:0 12px 26px rgba(16,64,47,.14);}
...
.ab-review{position:relative;background:#e6f1ec;border:1px solid #cfe3d9;border-radius:18px;padding:24px;margin:28px 0;}
...
.ab-journal-item:hover{transform:translateY(-2px);box-shadow:0 10px 22px rgba(16,64,47,.09);border-color:#cfe3d9;}
...
.faq-cats button{display:flex;align-items:center;gap:10px;width:100%;text-align:left;font-size:13px;font-weight:600;color:#36473f;padding:10px 11px;border-radius:9px;transition:background .12s,color .12s;}
.faq-cats button:hover{background:#e6f1ec;color:var(--brand-deep);}
.faq-cats button svg{color:var(--brand);flex:0 0 auto;}
.faq-help{background:#e6f1ec;border:1px solid #cfe3d9;border-radius:16px;padding:17px;}
.faq-help>b{font-family:'Fraunces';font-weight:600;font-size:16px;}
.faq-help>p{font-size:12.5px;color:#54655c;line-height:1.5;margin:6px 0 13px;}
.faq-help-cta{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:13.5px;padding:11px;border-radius:11px;box-shadow:0 6px 14px rgba(31,122,90,.28);}
...
.faq-empty{background:var(--card);border:1px solid var(--line);border-radius:13px;padding:18px;font-size:13.5px;color:#46564e;}
...
.ct-wa{display:flex;align-items:center;justify-content:center;gap:9px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:15.5px;padding:15px;border-radius:13px;box-shadow:0 8px 18px rgba(31,122,90,.3);}
...
.ct-form-sub{font-size:13px;line-height:1.5;color:#46564e;margin-bottom:15px;}
...
.ct-send{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:14px;padding:13px;border-radius:11px;box-shadow:0 6px 14px rgba(31,122,90,.28);}
...
.ct-map-pin{position:absolute;left:50%;top:44%;transform:translate(-50%,-50%) rotate(-45deg);display:grid;place-items:center;width:34px;height:34px;border-radius:50% 50% 50% 0;background:var(--brand);color:#fff;box-shadow:0 6px 13px rgba(16,64,47,.4);z-index:2}
...
.ct-hours-list li{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:9px 13px;font-size:12.5px;color:#46564e;}
.ct-hours-list li+li{border-top:1px solid var(--line);}
.ct-hours-list li b{font-weight:600;color:#36473f;}
.ct-hours-list li.today{background:#e6f1ec;color:var(--brand-deep);}
...
.rf-list li{display:flex;align-items:flex-start;gap:10px;font-size:14px;line-height:1.55;color:#36473f;}
...
.rf-keys li span{font-size:12.5px;color:#46564e;}
...
.rf-related button{display:flex;align-items:center;justify-content:space-between;width:100%;font-size:13.5px;font-weight:600;color:#36473f;padding:11px;border-radius:10px;transition:background .12s,color .12s;}
.rf-related button:hover{background:#e6f1ec;color:var(--brand-deep);}
...
.tm-intro{font-size:15px;line-height:1.6;color:#46564e;max-width:70ch;}
...
.tm-section p{font-size:14px;line-height:1.65;color:#36473f;margin-bottom:10px;}
...
.tm-contents button{text-align:left;font-size:12.5px;font-weight:600;color:#36473f;padding:8px 10px;border-radius:8px;transition:background .12s,color .12s;}
.tm-contents button:hover{background:#e6f1ec;color:var(--brand-deep);}
...
.pf-shot:hover{transform:translateY(-2px);box-shadow:0 14px 30px rgba(16,64,47,.16);}
...
.svc-intro{font-size:14px;color:#54655c;line-height:1.5;margin:-4px 0 24px;max-width:620px;}
...
.svc-fgroup h4{font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:#778a81;margin-bottom:8px;}
.svc-radios{display:flex;flex-direction:column;gap:1px;}
.svc-radios button{text-align:left;font-size:13.5px;font-weight:500;padding:8px 10px;border-radius:9px;color:#36473f;}
.svc-radios button:hover{background:#f3e7e1;}
.svc-radios button.on{background:#e6f1ec;color:var(--brand-deep);font-weight:700;}
.svc-book-card{background:var(--card);border:1px solid var(--line);border-radius:16px;padding:16px;box-shadow:0 8px 22px rgba(16,64,47,.06);}
...
.svc-next{font-size:13px;color:#46564e;margin:10px 0 14px;}
.svc-next b{color:var(--ink);}
.svc-book-cta{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:14.5px;padding:12px;border-radius:12px;box-shadow:0 6px 16px rgba(31,122,90,.3);}
...
.svc-card:hover{transform:translateY(-2px);box-shadow:0 12px 28px rgba(16,64,47,.1);}
...
.svc-card-desc{font-size:12.5px;color:#54655c;line-height:1.5;margin-top:8px;flex:1;}
...
.svc-card-book{display:inline-flex;align-items:center;gap:3px;font-size:13px;font-weight:700;color:#fff;background:var(--brand);padding:8px 14px;border-radius:10px;box-shadow:0 4px 10px rgba(31,122,90,.3);}
...
.svc-deliv li{display:flex;align-items:flex-start;gap:8px;font-size:12.5px;color:#46564e;line-height:1.4;}
...
.rev-leave{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;background:var(--brand);color:#fff;font-weight:700;font-size:14.5px;padding:12px;border-radius:12px;box-shadow:0 6px 16px rgba(31,122,90,.3);}
...
.rev-filter-m button{display:inline-flex;align-items:center;gap:4px;font-size:12.5px;font-weight:600;padding:7px 13px;border-radius:10px;border:1px solid var(--line);background:var(--card);color:#36473f;}
...
.rev-photostrip h4{font-size:12.5px;font-weight:700;color:#46564e;margin-bottom:10px;}
...
.rev-card-svc{display:inline-block;font-size:11px;font-weight:700;color:var(--brand-deep);background:#e6f1ec;padding:3px 9px;border-radius:7px;margin:11px 0 8px;}
.rev-card-text{font-size:13.5px;line-height:1.55;color:#36473f;}
...
.rev-response p{font-size:12.5px;line-height:1.5;color:#46564e;}
.rev-form-note{display:flex;align-items:flex-start;gap:7px;font-size:12.5px;color:#54655c;line-height:1.5;background:#e6f1ec;border:1px solid #cfe3d9;border-radius:11px;padding:11px 12px;margin-bottom:6px;}
...
.rev-input:focus,.rev-textarea:focus{outline:none;border-color:var(--brand);box-shadow:0 0 0 3px rgba(31,122,90,.12);}

  ...
  return (
    <section className="admin-section animate-fade-in">
      <div className="admin-section-heading">
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span className="admin-chip admin-chip--green" style={{ fontSize: 11 }}>Financial Management</span>
          </div>
          <p style={{ marginTop: 4, color: 'var(--text-muted)', fontSize: 13 }}>
            Review, audit, and approve withdrawal requests, automated payout batches, SLA thresholds, and bank security logs.
          </p>
        </div>
        <button
          type="button"
        ...
        >
          <RefreshCw size={15} className={withdrawalsLoading ? 'admin-spin' : ''} /> Refresh
        </button>
      </div>
      ...
      <div className="admin-sub-tabs" style={{ display: 'flex', gap: 10, marginBottom: 20, borderBottom: '1px solid var(--border)', paddingBottom: 10 }}>
        <a href="/admin/withdrawals" className="admin-sub-tab is-active" style={{ padding: '8px 16px', borderRadius: 8, background: 'var(--primary-light)', color: 'var(--primary)', fontWeight: 700, fontSize: 13, textDecoration: 'none' }}>
          Payout Requests
        </a>

...
const DEFAULT_COMPARISON_ROWS = [
  ...
  { feat: 'Pricing', alo: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — same flat 1.5% fee on every tier', sho: '$5–$399+/month by tier, Plus from $2,300+/month', oth: 'Bumpa: ₦15k–30k+/quarter by tier · Selar: free to start + ~₦22,500/month premium' },
];

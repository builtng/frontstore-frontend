...
export const SOLUTION_PAGES: SolutionPage[] = [
  {
    ...
    directAnswer: 'To sell on WhatsApp in Nigeria, a merchant needs a way to show products, take orders, and get paid without spamming customers with dozens of images in a single chat thread. The fastest route is a dedicated storefront link — like yourbrand.frontstore.ng — that customers browse before ordering, where the order itself becomes a formatted WhatsApp message straight to the seller.',
    sections: [
      {
    ...
    steps: [
      { title: 'Claim a store link', body: 'Pick a name and get a link like yourbrand.frontstore.ng — this takes under a minute.' },

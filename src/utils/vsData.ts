...
export const VS_COMPETITORS: VsCompetitor[] = [
  ...
  },
  {
    ...
    pricingNote: 'MyShoplet publishes three monthly tiers: Growth at ₦15,000/month (with a 1% transaction fee), Pro at ₦35,000/month (0% transaction fee), and an Enterprise tier at ₦75,000/month for multi-location businesses. Frontstore offers a Free plan, Pro at ₦2,000/month (₦25,000/year), and Legend at ₦7,000/month (₦100,000/year), all carrying the same flat 1.5% transaction fee — the fee itself never changes by tier, unlike MyShoplet where upgrading is the only way to lower it.',
    ...
    gaps: [
      'Entry-level pricing (₦15,000/month) is 10x Frontstore\'s Pro plan (₦2,000/month), even before either platform\'s transaction fees',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — same flat 1.5% fee on every tier', competitor: '₦15,000–₦75,000/month by tier; 1%–0% transaction fee depending on tier' },
  ...
  },
  {
    ...
    pricingNote: 'Selar offers a free plan (transaction fees apply on sales), a Pro plan around ₦12,000/$30 per month, and a Turbo plan around ₦22,500/$45 per month, plus a per-transaction fee of roughly 4% + ₦50 on Naira sales. Frontstore offers a Free plan, Pro at ₦2,000/month (₦25,000/year), and Legend at ₦7,000/month (₦100,000/year), all carrying the same flat 1.5% per-sale transaction fee — well under half Selar\'s rate on every tier, with no fixed ₦50 add-on.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — plus the same flat 1.5% per sale on every tier', competitor: 'Free plan, or ₦12,000–₦22,500/month, plus ~4% + ₦50 per sale' },
    ...
    faqs: [
      ...
      { question: 'Does Frontstore charge a transaction fee like Selar?', answer: 'Yes, but a lower one, and it doesn\'t change by plan. Frontstore charges a flat 1.5% per sale on Free, Pro (₦2,500/month or ₦25,000/year), and Legend (₦10,000/month) alike, with no fixed fee added. Selar applies a per-transaction fee of roughly 4% + ₦50 on Naira sales in addition to any subscription plan.' },
  ...
  },
  {
    ...
    pricingNote: 'Shopify\'s Basic plan starts at $19/month billed yearly ($27/month billed monthly), with Grow at $54/month and Advanced at $299/month (all yearly pricing) — plus a third-party payment fee of 2% down to 0.6% depending on tier if a merchant doesn\'t use Shopify Payments, which isn\'t available in most African countries. Frontstore starts free, with Pro at ₦2,000/month (roughly $1.33/month) and Legend at ₦7,000/month, plus a flat 1.5% transaction fee on every sale — the same fee regardless of tier.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ~$1.33/mo (₦2,000), or Legend ~$4.67/mo (₦7,000), plus a flat 1.5% transaction fee', competitor: '$19–$299+/month (yearly pricing), plus 0.6%–2% third-party payment fees' },

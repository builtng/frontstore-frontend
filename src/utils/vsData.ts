...
export const VS_COMPETITORS: VsCompetitor[] = [
  {
    ...
    pricingNote: 'Bumpa is billed in tiers starting around ₦15,000 per quarter for the Starter plan and roughly ₦30,000 per quarter for Pro, with Growth, Scale, and Premium tiers priced on request as merchants add staff seats and locations. Frontstore offers a Free plan, Pro at ₦2,000 a month (₦24,000 a year), and Legend at ₦7,000 a month (₦84,000 a year) — WhatsApp checkout and AI listings are included on every paid tier, not gated behind a separate add-on, and none of Frontstore\'s prices rise with staff seats or locations the way Bumpa\'s do.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — never rises with staff or locations', competitor: 'Tiered plans from ~₦15,000/quarter, higher tiers for staff & locations' },
  ...
  },
  {
    ...
    pricingNote: 'MyShoplet publishes three monthly tiers: Growth at ₦15,000/month (with a 1% transaction fee), Pro at ₦35,000/month (0% transaction fee), and an Enterprise tier at ₦75,000/month for multi-location businesses. Frontstore offers a Free plan, Pro at ₦2,000/month (₦25,000/year), and Legend at ₦7,000/month (₦100,000/year), with no transaction fee on any tier — unlike MyShoplet where upgrading is the only way to lower it.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — no transaction fee on any tier', competitor: '₦15,000–₦75,000/month by tier; 1%–0% transaction fee depending on tier' },
    ...
    switchReasons: [
      { title: 'No transaction fee to work around by upgrading', body: 'MyShoplet\'s entry tier carries a 1% transaction fee, and dropping to 0% means paying ₦35,000/month for the Pro plan. Frontstore doesn\'t charge a transaction fee on Free, Pro, or Legend, so there\'s no fee to dodge by upgrading a plan.' },
  ...
  },
  {
    ...
    pricingNote: 'Catlog runs paid monthly plans (billed monthly, quarterly, biannually, or yearly, with a discount for longer commitments), though published tier pricing has varied across its own marketing pages — check catlog.shop/pricing for current rates. Frontstore offers a Free plan, Pro at ₦2,000/month (₦25,000/year), and Legend at ₦7,000/month (₦100,000/year) — none of which change with catalogue size.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — none scale with catalogue size', competitor: 'Paid monthly plans; published tier pricing varies by source' },
  ...
  },
  {
    ...
    pricingNote: 'Selar offers a free plan (transaction fees apply on sales), a Pro plan around ₦12,000/$30 per month, and a Turbo plan around ₦22,500/$45 per month, plus a per-transaction fee of roughly 4% + ₦50 on Naira sales. Frontstore offers a Free plan, Pro at ₦2,000/month (₦25,000/year), and Legend at ₦7,000/month (₦100,000/year), with no per-sale transaction fee on any tier and no fixed ₦50 add-on.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — no per-sale fee on any tier', competitor: 'Free plan, or ₦12,000–₦22,500/month, plus ~4% + ₦50 per sale' },
    ...
    switchReasons: [
      ...
      { title: 'No transaction fee at all, on any tier', body: 'Selar\'s ~4% + ₦50 transaction fee applies on top of any subscription. Frontstore doesn\'t charge a per-sale fee on Free, Pro, or Legend, so more of each sale on physical goods stays with the merchant.' },
    ...
    faqs: [
      ...
      { question: 'Does Frontstore charge a transaction fee like Selar?', answer: 'No — Frontstore doesn\'t charge a transaction fee on Free, Pro (₦2,500/month or ₦25,000/year), or Legend (₦10,000/month). Selar applies a per-transaction fee of roughly 4% + ₦50 on Naira sales in addition to any subscription plan.' },
  ...
  },
  {
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ₦2,000/mo, or Legend ₦7,000/mo — published upfront', competitor: 'Pricing not published on main site; requires signup to view' },
    ],
    switchReasons: [
    ...
    faqs: [
      ...
      { question: 'Is Vendda or Frontstore cheaper?', answer: 'Vendda does not publish pricing on its main marketing pages, so a direct comparison requires creating an account. Frontstore publishes its pricing upfront: free to start, Pro at ₦2,000/month (₦25,000/year), or Legend at ₦7,000/month.' },
  ...
  },
  {
    ...
    pricingNote: 'Shopify\'s Basic plan starts at $19/month billed yearly ($27/month billed monthly), with Grow at $54/month and Advanced at $299/month (all yearly pricing) — plus a third-party payment fee of 2% down to 0.6% depending on tier if a merchant doesn\'t use Shopify Payments, which isn\'t available in most African countries. Frontstore starts free, with Pro at ₦2,000/month (roughly $1.33/month) and Legend at ₦7,000/month, with no transaction fee on any tier.',
    ...
    featureRows: [
      ...
      { feature: 'Pricing model', frontstore: 'Free, Pro ~$1.33/mo (₦2,000), or Legend ~$4.67/mo (₦7,000), no transaction fee on any tier', competitor: '$19–$299+/month (yearly pricing), plus 0.6%–2% third-party payment fees' },
    ...
    faqs: [
      ...
      { question: 'Why is Shopify so much more expensive than Frontstore?', answer: 'Shopify is priced in US dollars for a global market and includes infrastructure for large catalogs, app ecosystems, and enterprise scale. Frontstore\'s ₦2,000/month Pro plan (or ₦10,000/month for Legend) reflects a narrower, WhatsApp-focused feature set built for African micro and small merchants.' },
    ],
  },
];
